...
<body>
    <div class="container">
        ...
        <div>
            <h1 style="color: #707070;text-align: center;font-family: Arial, Helvetica, sans-serif ;">Saída do Estoque</h1>
        </div>
        <div class="box">
            <form action="./formEstoqueSalvarSaida.php" method="POST">
                <fieldset>
                    <br>
                    <div class="inputBox">
                    ...
                    <div class="inputBox">
                        ...
                        <label for="qtd_estoque" class="labelInput">Quantidade da saída de estoque</label>
                    </div>
                    <br><br>
                <input type="hidden" name="SaldoAtual" value=<?php echo $qtd_estoque;?>>
				<input type="hidden" name="id" value=<?php echo $id;?>>
                <input class="btn" type="submit" name="update" id="update" value="Confirmar saída do estoque">
            </fieldset>
            </form>
        </div>
    </div>
